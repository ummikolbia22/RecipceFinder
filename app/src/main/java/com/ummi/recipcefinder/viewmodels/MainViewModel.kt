...
import com.ummi.recipcefinder.data.Repository
...
class MainViewModel @ViewModelInject constructor(
    ...
    fun insertFavoriteRecipe(favoritesEntity: FavoriteEntity) =
        viewModelScope.launch(Dispatchers.IO) {
    ...
    fun deleteFavoriteRecipe(favoritesEntity: FavoriteEntity) =
        viewModelScope.launch(Dispatchers.IO) {
